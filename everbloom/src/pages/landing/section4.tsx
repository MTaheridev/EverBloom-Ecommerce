  ...
  return (
    <div className="h-lvh w-lvw overflow-hidden flex flex-col relative pt-20">
      <div className="w-lvw h-lvh absolute top-0 left-0 z-0">
        ...
        <div className="w-full h-full absolute z-10 left-0 top-0 bg-bgPrimary/50"></div>
      </div>
      <div className="z-20 flex flex-col justify-between pl-8 pt-4 lg:mt-8 xl:ml-20 h-28 lg:h-24">
        <h1 className="text-3xl lg:text-4xl xl:text-4xl">Plant Care Hub</h1>
        <div className="flex flex-col lg:flex-row">
          <p className="text-xl xl:text-2xl mr-1">
            Your Plants Deserve More Than
          </p>
          <p className="text-xl xl:text-2xl">Survival – Thrive with Us!</p>
        </div>
      </div>
      <div className="flex flex-col items-center z-0 self-center absolute bottom-0">
        <p>scroll to learn about your green roommates</p>
