...
export const MyHeader = () => {
  return (
    <div className="w-lvw px-4 xl:px-[5vw] lg:self-center h-20 flex flex-row justify-between items-center sticky top-0 z-40 bg-gradient-to-b from-bgPrimary to-bgPrimary/0">
