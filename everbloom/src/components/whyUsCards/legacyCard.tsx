  ...
  return (
    <div className={`${className} relative rounded-xl overflow-hidden border-2 border-accentPrimary`}>
        ...
        <div className='z-10 absolute bg-bgPrimary/40 top-0 left-0 w-full h-full backdrop-blur-[2px] flex flex-col justify-between p-4'>
            <div className=''>
                <p className='text-xl lg:text-2xl xl:text-3xl font-medium'>Speediest</p>
                <p className='text-xl lg:text-2xl xl:text-3xl font-medium'>Plant Delivery</p>
            </div>
            <p className='text-sm lg:text-lg xl:text-xl w-[100%] text-balance'>For every plant sold, we donate a sapling to urban parks.</p>
        </div>
    </div>
  );
};
