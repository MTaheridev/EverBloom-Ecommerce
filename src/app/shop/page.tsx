    ...
    <div>
      <div className="w-full h-[calc(100vh-80px)] flex flex-col justify-between items-center">
        <div className="flex flex-row lg:hidden justify-between w-full p-4 z-20">
          <button className="w-[39%] h-12 border-1 border-accentSecondary rounded-lg">
        ...
        <div className="w-full h-full overflow-scroll flex flex-wrap justify-center items-center pt-4 gap-2 px-4 z-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button className="h-12 w-auto px-4 border-1 border-txtSecondary rounded-lg flex flex-row gap-2 justify-evenly items-center">
                  <Icon icon={"solar:moon-linear"} className="text-txtSecondary text-2xl"/>
                  <p>Low Light</p>
                </button>
                <button className="h-12 w-auto px-4 border-1 border-txtSecondary rounded-lg flex flex-row gap-2 justify-evenly items-center">
                <Icon icon={"ph:cloud-sun-light"} className="text-txtSecondary text-2xl"/>
                  <p>Medium Light</p>
                </button>
                <button className="h-12 w-auto px-4 border-1 border-txtSecondary rounded-lg flex flex-row gap-2 justify-evenly items-center">
                <Icon icon={"si:sun-duotone"} className="text-txtSecondary text-2xl"/>
                  <p>Bright Light</p>
                </button>
              </div>
            </div>
